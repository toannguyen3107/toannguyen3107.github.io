...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="get" class="w-10/12 md:w-5/12 flex flex-row flex-wrap bg-green-400 p-3 align-center border-2 border-4 border-indigo-500/100 rounded-lg mx-auto justify-center">
        <!-- <input type="text" class="bg-slate-100 w-full p-2 border-2 border-black rounded-xl mb-3" disabled id="res" value="3234" name="ret"> -->
        <input type="text" class="bg-slate-100 w-full p-2 border-2 border-black rounded-xl mb-3" value="<?php echo $result;?>" name='ret' id="res">
        <div class="w-3/12">
        ...
        <input type="submit" class="w-9/12 focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900" value="=">
</form>
