...
<body>
    ...
    ?>
    <form action="./index.php" method="get" class="w-10/12 flex flex-row flex-wrap bg-green-400 p-3 align-center border-2 border-4 border-indigo-500/100 rounded-lg mx-auto justify-center" value="2">
